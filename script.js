...
// Event listeners for unit conversion click
...
let weather = {
	...
	show(response) {
		...
		document.getElementById('clouds')
			.innerHTML = response.clouds.all;
		document.getElementById('winds')
			.innerHTML = response.wind.speed;
		document.getElementById('pop')
			.innerHTML = response.main.humidity;
		document.getElementById('temperature')
			.innerHTML = Math.round(response.main.temp);
		document.getElementById('max')
			.innerHTML = response.main.temp_max;
		document.getElementById('min')
			.innerHTML = response.main.temp_min;
		document.getElementById('city')
			.innerHTML = response.name;
		document.getElementById('country')
			.innerHTML = response.sys.country;
		document.getElementById('desc')
			.innerHTML = response.weather[0].main;
		document.getElementById('icon')
			.innerHTML = `<img src="${response.weather["0"].icon}" style="height: 150px;width: 175px;"></img>`;
	},
	convert() {
